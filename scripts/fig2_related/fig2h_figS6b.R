...
ggsave(
  filename = file.path(fig_dir, "fig2h_top.pdf"),
  plot = snrna_mp_panel,
...
plot_mp_box(
  ...
  out_file = file.path(fig_dir, "fig2h_top_sig.pdf")
)
...
plot_mp_box(
  ...
  group_name = "subtype",
  fill_cols = subtype_col1,
  out_file = file.path(fig_dir, "fig2h_bottom.pdf")
)
...
plot_mp_box(
  ...
  out_file = file.path(fig_dir, "figS6b_stage.pdf")
)
...
plot_mp_box(
  ...
  out_file = file.path(fig_dir, "figS6b_age.pdf")
)
...
plot_mp_box(
  ...
  out_file = file.path(fig_dir, "figS6b_fusion.pdf")
)
...
plot_mp_box(
  ...
  group_name = "site",
  fill_cols = site_col,
  out_file = file.path(fig_dir, "figS6b_site.pdf")
)
