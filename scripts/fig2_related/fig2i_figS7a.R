...
# ---- outputs ----
save_ridge("sig-21115", "fig2i_sorafenib.pdf")
save_ridge("sig-21303", "fig2i_ibrutinib.pdf")
save_ridge("sig-21353", "fig2i_vincristine.pdf")
save_ridge("sig-21139", "figS7a_axitinib.pdf")
save_ridge("sig-21175", "figS7a_sunitinib.pdf")
save_ridge("sig-20958", "figS7a_vinorelbine.pdf")
save_ridge("sig-21025", "figS7a_tak901.pdf")