...
plot_signal_circle(object_list, pathway = "BAFF", outfile = "figS10c.pdf")
plot_signal_circle(object_list, pathway = "CD40", outfile = "figS10d.pdf")