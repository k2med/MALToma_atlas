...
plot_irea_dot(mac_df, size_limits = c(0, 15), outfile = "figS8c.pdf", fig_dir = fig_dir)

# ========== DC =============
dc_subtypes <- c("cDC1_XCR1", "cDC2_CLEC10A", "pDC_CLEC4C")
...
dc_files <- c(
  "cDC1_XCR1"   = "XCR1_IREA_output.csv",
  "cDC2_CLEC10A"= "CLEC10A_IREA_output.csv",
...
plot_irea_dot(dc_df, size_limits = c(0, 30), outfile = "figS8f.pdf", fig_dir = fig_dir)
