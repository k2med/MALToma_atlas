...
seurat_vec   <- subset(seurat_stromal, fine_cell_type %in% c("Endo_venous", "Endo_arterial"))
...
# ---- runs ----
run_ct2_boxplot(seurat_fibro, outfile = "figS9a.pdf")
run_ct2_boxplot(seurat_vec,   outfile = "figS9f.pdf")
