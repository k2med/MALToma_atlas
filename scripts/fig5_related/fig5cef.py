...
plt.savefig(FIG_DIR / "fig5c_HE.pdf", dpi=300, bbox_inches="tight")
# Other panels in fig5c were obtained from:
# "./colocation/cell2location_map/CoLocatedComb/CoLocatedGroupsSklearnNMF_30515locations_25factors/spatial"

# fig5e (left/right): S06_ST, up to 6 clusters
clust_labels = ["B_Mal", "CD8T_Tex", "CD4T_Treg", "cDC1_XCR1", "cDC2_CLEC10A", "Fibro_CCL19"]
...
plt.savefig(FIG_DIR / "fig5e_left.pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig(FIG_DIR / "fig5e_right.pdf", dpi=300, bbox_inches="tight")
plt.close()

# fig5f (left/right): S31_ST, up to 6 clusters
clust_labels = ["B_Mal", "Neu_G0S2", "Mac_MARCO", "Endo_arterial", "Endo_venous", "Peri_PDGFRB"]
...
plt.savefig(FIG_DIR / "fig5f_left.pdf", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig(FIG_DIR / "fig5f_right.pdf", dpi=300, bbox_inches="tight")
plt.close()
