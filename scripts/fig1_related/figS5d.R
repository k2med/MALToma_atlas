...
# ---- LME_1 vs LME_3 ridge plot ----
keep_terms_c1vc3 <- c(
  "Angiogenesis [HALLMARK]",
  "Regulation of endothelial cell development [GOBP]",
  "Regulation of endothelial cell differentiation [GOBP]",
  "Tgf beta receptor signaling activates smads [REACTOME]",
  "Regulation of extracellular matrix assembly [GOBP]",
...
ggsave(
  file.path(fig_dir, "figS5d_left.pdf"),
  egg::set_panel_size(p_c1vc3, width = unit(1.5, "cm"), height = unit(2, "cm")),
  height = 8, width = 16, units = "cm"
)

# ---- LME_2 vs LME_3 ridge plot ----
keep_terms_c2vc3 <- c(
  "Regulation of antigen processing and presentation [GOBP]",
  "Mhc protein complex [GOCC]",
  "Interferon alpha response [HALLMARK]",
  "Interferon gamma signaling [REACTOME]",
  "Activation of innate immune response [GOBP]",
...
ggsave(
  file.path(fig_dir, "figS5d_right.pdf"),
