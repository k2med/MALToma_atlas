...
run_marker_heatmap(
  ...
  celltype_levels = c("CD8T_Teff","CD8T_Temra","CD8T_Tex","CD4T_Treg","CD4T_Tfh","CD4T_Tn"),
...
run_marker_heatmap(
  ...
  celltype_levels = c("Mac_SPARC","Mac_STAB1","Mac_MARCO","Mac_CHIT1",
                      "cDC1_XCR1","cDC2_CLEC10A","pDC_CLEC4C","Neu_G0S2","Mast_CPA3"),
...
run_marker_heatmap(
  ...
  celltype_levels = c("Endo_venous","Endo_arterial","Endo_lymphatic","Endo_aerocyte","Peri_PDGFRB",
                      "Fibro_PI16","Fibro_CCL19","Fibro_LRRC15","Fibro_alveolar","FDC_CR2"),
