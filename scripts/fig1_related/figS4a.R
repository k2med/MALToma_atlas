...
ggsave(
  file.path(fig_dir, "figS4a_dotplot.pdf"),
...
# ---- tidy for pie ----
cells_keep <- c("Fibro_alveolar", "AT1_AGER", "AT2_SFTPC", "Hepa_ALB", "Endo_aerocyte")
...
pie_df$cell <- factor(
  pie_df$cell,
  levels = c("Hepa_ALB", "AT2_SFTPC", "AT1_AGER", "Endo_aerocyte", "Fibro_alveolar")
)
...
ggsave(
  file.path(fig_dir, "figS4a_pie.pdf"),
